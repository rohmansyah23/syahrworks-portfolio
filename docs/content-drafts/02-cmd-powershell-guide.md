# Draft Artikel Blog #2 — Panduan Lengkap Perintah CMD & PowerShell

> **Status:** DRAFT — menunggu review user sebelum dimigrasi ke `data/blog.ts`
> Metadata mengikuti tipe `BlogPost`. Isi body mengikuti prompt "Instruktur Windows" yang diberikan user.
...
// Metadata (untuk data/blog.ts)
{
  ...
  title: "Panduan Lengkap Perintah CMD & PowerShell untuk Pemula hingga Administrator",
  date: "2026-08-05",
  excerpt:
  ...
  coverImage: "/projects/auto-refresh.png", // ganti bila ada cover khusus
