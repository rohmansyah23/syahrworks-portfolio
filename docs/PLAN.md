...
- **about** → `data/about.ts` (aboutImage, intro, philosophy[], workingStyle[], favoriteTech[], quote, resumeUrl = `/CV-Muhammad-Rohman-Syah-ID.pdf` (ID) / `/CV-Muhammad-Rohman-Syah-EN.pdf` (EN) self-hosted di `public/`).
