...
- **about**: aboutImage, intro (dari data lama), philosophy[], workingStyle[], favoriteTech[], quote, resumeUrl (`/CV-Muhammad-Rohman-Syah-ID.pdf` untuk locale ID, `/CV-Muhammad-Rohman-Syah-EN.pdf` untuk locale EN — self-hosted di `public/`).
